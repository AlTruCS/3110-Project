...
BSTNode::BSTNode(std::string newName, std::string newStreet, std::string newCity, std::string newState, std::string newZipCode, int newID, BSTNode* newLeft, BSTNode* newRight)
{
    name = newName;
    street = newStreet;
    city = newCity;
